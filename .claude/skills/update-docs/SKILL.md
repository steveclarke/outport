...
|-------------|--------------|-----------------|
| **New command** | README commands, CLAUDE.md commands | init presets |
| **Config schema change** | README config example, CLAUDE.md config description | init presets |
| **New convention** | CLAUDE.md | — |
| **Infrastructure** | — | releasing.md, CLAUDE.md dev commands |
| **Bug fix** | — | README (if workaround documented) |
